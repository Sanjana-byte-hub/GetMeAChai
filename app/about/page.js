  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white px-6 py-16 flex flex-col items-center">
      ...
      <div className="max-w-4xl mt-12">
        ...
        <ul className="text-slate-400 list-disc list-inside space-y-2">
          <li>
            <span className="text-white font-medium">Next.js 14</span> — For
            building the frontend and backend in one framework.
          </li>
          <li>
            <span className="text-white font-medium">Tailwind CSS</span> — For
            modern, responsive, and utility-first styling.
          </li>
          <li>
            <span className="text-white font-medium">NextAuth.js</span> — For
            secure authentication using GitHub.
          </li>
          <li>
            <span className="text-white font-medium">Razorpay API</span> — For
            handling payments and donations.
          </li>
          <li>
            <span className="text-white font-medium">MongoDB</span> — For storing
            user data and donation records.
          </li>
        </ul>
      </div>
      ...
      <div className="max-w-4xl mt-12 text-center">
        <h2 className="text-2xl font-semibold text-blue-400 mb-3">
          ❤️ A Small Project with Big Heart
        </h2>
        <p className="text-slate-400 text-base leading-relaxed">
